...
本文档用于记录 C1 每次任务结束后的审阅报告。之后每次我完成 C1 相关任务时，会在这里追加一条报告，并标明当时版本号。

## 当前版本

- 分支：`speng/c1-person-events`
- 版本号：`2ba9064`
- 记录时间：`2026-06-24 08:31:03 CST`
...
- 文档内容：C1 base URL、健康检查、人脸以图搜人接口、人物特征搜索接口、media 图片 URL、枚举值、请求/响应示例、C2 展示建议、错误处理和 known limitations。
