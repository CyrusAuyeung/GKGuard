...
- 文档形态：仓库内维护中英双语 README、API 合同、C1/C2 集成说明、演示脚本、数据字典、发布说明和治理文档。
...
- 离线或无校园网/VPN/SSH 隧道环境下，真实 C1 检索不可用；此时前端使用 mock fallback 展示 C2 壳体流程。
...
- Documentation shape: the repository maintains bilingual README, API contract, C1/C2 integration notes, demo script, data dictionary, release notes, and governance documents.
...
- Real C1 search is unavailable offline or without campus network, VPN, or SSH tunnel access; in that case, the frontend uses mock fallback for the C2 shell flow.
