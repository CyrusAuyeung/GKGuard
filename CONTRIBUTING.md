...
- `test(ui): add browser E2E workflow for v0.1.25`
...
```powershell
.\scripts\Update-RoadmapItem.ps1 -Url https://github.com/CyrusAuyeung/GKGuard/pull/123 -Status "Review" -Area "Frontend" -Type "Polish" -Priority "Medium" -Blocked "No" -StartDate 2026-06-17 -TimelineOrder 22 -TargetVersion "post-v0.1.25"
```
