...
Returns recent audit log entries generated by sensitive demo actions such as image search, case report generation, and disposition archiving.

## Case Package Export

`GET /events/{event_id}/case-package`

Returns a structured case package containing event detail, subject data, report, timeline summary, timeline points, evidence snapshots, related audit logs, and a handoff checklist.
