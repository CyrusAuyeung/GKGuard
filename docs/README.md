...
- [releases/v0.2.1.md](releases/v0.2.1.md)：当前最新版本说明，记录 CampusVision C1 事件与人物特征查询接口、GKGuard C2 事件检索代理、人物特征检索 UI、事件关键帧/人体图/人脸图媒体代理、结果页属性摘要、CampusVision C1 路由保护补齐、CampusVision C1 服务稳定性修复，以及 Windows/macOS/Linux 桌面发布资产。
