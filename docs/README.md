...
本文档用于维护时快速定位材料。当前文档以 `v0.1.31` 为最新状态，历史发布说明保留各版本发布时的语境。
...
- [releases/v0.1.31.md](releases/v0.1.31.md)：当前最新版本说明，记录结果页人物照片与选中人脸框坐标来源统一、CampusVision C1 源图尺寸 bbox 换算和裁切内容回归测试。
...
Use this page to locate maintenance material quickly. The current-state documentation tracks `v0.1.31`; historical Release notes keep the context from each release.
...
- [releases/v0.1.31.md](releases/v0.1.31.md): latest release notes covering aligned coordinate sources for the result portrait and selected face box, CampusVision C1 source-image bbox conversion, and crop-content regression coverage.
