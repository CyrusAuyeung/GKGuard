...
本文档用于维护时快速定位材料。当前文档以 `v0.1.28` 为最新状态，历史发布说明保留各版本发布时的语境。
...
- [releases/v0.1.28.md](releases/v0.1.28.md)：当前最新版本说明，记录 CampusVision C1 远端半自动部署脚本的 Windows/SSH 换行兼容修复，以及远端查询图预处理测试期望修正。
...
Use this page to locate maintenance material quickly. The current-state documentation tracks `v0.1.28`; historical Release notes keep the context from each release.
...
- [releases/v0.1.28.md](releases/v0.1.28.md): latest release notes covering the Windows/SSH newline compatibility fix for the semi-automatic CampusVision C1 remote deployment script and the remote query-image preprocessing test expectation fix.
