...
GKGuard 涉及校园安防演示、人脸以图搜人、轨迹展示和服务器连接配置。请优先保护人员隐私、服务器凭据和真实媒体数据。
...
| 版本 | 状态 |
|---|---|
| v0.3.2 | 当前维护版本，接受安全修复 |
| v0.3.0 - v0.3.1 | 已被 v0.3.2 替代；建议升级到最新版 |
| v0.2.0 - v0.2.3 | 已被 v0.3.2 替代；建议升级到最新版 |
| v0.1.9 - v0.1.37 | 已被 v0.3.2 替代；建议升级到最新版 |
...
| Version | Status |
|---|---|
| v0.3.2 | Current maintained version, accepts security fixes |
| v0.3.0 - v0.3.1 | Superseded by v0.3.2; upgrade to the latest release |
| v0.2.0 - v0.2.3 | Superseded by v0.3.2; upgrade to the latest release |
| v0.1.9 - v0.1.37 | Superseded by v0.3.2; upgrade to the latest release |
