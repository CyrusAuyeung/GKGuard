...
GKGuard 当前是课程/项目演示仓库，治理目标是保持 C2 边界清晰、Release 可复现、文档可交接、敏感数据不进入仓库。
...
- 文档维护者：负责 README、API 合同、数据字典、演示脚本、交接材料和 Release notes。
...
- 影响当前行为或交付边界的变更需要同步 README、`docs/README.md`、API/集成/演示/支持/安全等相关文档。
...
GKGuard is currently a coursework/project demo repository. Governance focuses on keeping the C2 boundary clear, Releases reproducible, documentation handoff-ready, and sensitive data out of the repository.
...
- Documentation maintainers: own README, API contracts, data dictionary, demo script, handoff material, and Release notes.
...
- Changes that affect current behavior or delivery boundaries must also update README, `docs/README.md`, and relevant API/integration/demo/support/security docs.
