...
当前建议版本：`v0.1.17`。报告问题时请优先注明使用的 Release tag、安装包来源和 CampusVision C1 服务连接方式。
...
Recommended current version: `v0.1.17`. When filing an issue, include the Release tag, installer source, and CampusVision C1 service connection path.
