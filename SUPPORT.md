...
当前建议版本：`v0.2.2`。反馈问题时请注明使用的版本标签、安装文件来源、操作系统和 CampusVision C1 服务连接方式。
...
Recommended current version: `v0.2.2`. When filing an issue, include the release tag, package source, operating system, and CampusVision C1 service connection path.
