...
当前建议版本：`v0.1.19`。反馈问题时请注明使用的版本标签、安装包来源和 CampusVision C1 服务连接方式。
...
Recommended current version: `v0.1.19`. When filing an issue, include the release tag, installer source, and CampusVision C1 service connection path.
